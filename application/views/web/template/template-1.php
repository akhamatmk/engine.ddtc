...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url(); ?>assets/themes/css/custom.css?v=9" rel="stylesheet">
  ...
  <div class="home-video">
    <video width="100%" height="auto" autoplay loop fullscreen >
       <source src="http://engine.ddtc.co.id/tax-engine.mp4" type='video/mp4; codecs="avc1.64001E, mp4a.40.2"'/>
       <source src="http://engine.ddtc.co.id/tax-engine.ogv" type='video/ogg; codecs="theora, vorbis"'/>
       <source src="http://engine.ddtc.co.id/tax-engine.webm" type='video/webm; codecs="vp8, vorbis"'/>
            ...
            <li class="dropdown">
              ...
              <div class="dropdown-menu dropdown-masuk">
                <form class="form-login" id="form-signin" action="<?php echo site_url(); ?>user/login" method="post" redirect="<?php echo site_url(); ?>home">
                      ...
                      <label><input type="checkbox" name="keep_login" value="1"> Tetap Masuk</label>
					  ...
					  <div class="btn-forget-pass"><a href="http://dannydarussalam.com/oldwebsite/password-recovery" target="blank_">Lupa Password?</a></div>
                </form>
              </div>
            </li>
            <li class="dropdown">
    ...
    <div class="container home-container"><?php echo $contents; ?></div>
  ...
  <?php
    $msg_changepassword = $this->session->flashdata('msg_changepassword');

    if($msg_changepassword != "")
    {
  ?>
    <script>
      $(document).ready(function()
      {
        var notification_body = "<?php echo $this->session->flashdata('msg_changepassword'); ?>";
        $('#notificationModal').find('#notification-title').html('Notification');
        $('#notificationModal').find('#notification-body').html('<p>'+notification_body+'</p>');
        $('#notificationModal').modal('show');
      });
