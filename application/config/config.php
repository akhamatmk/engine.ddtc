...
|
*/
$config['base_domain'] = ''; // a new config item if you need to get your domain name
$config['base_url'] = '';
...
// else
// {
//   $config['base_url'] = 'https://engine.ddtc.co.id/';
//}
...
$config['search_peraturan_pajak_login'] = false;
$config['search_putusan_pengadilan_login'] = false;
$config['search_p3b_login'] = false;
$config['search_putusan_ma_login'] = false;
